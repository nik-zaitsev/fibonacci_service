...
type FibonacciClient interface {
	GetFibonacciSlice(ctx context.Context, in *BorderValues, opts ...grpc.CallOption) (*FibonacciSlice, error)
}
...
func (c *fibonacciClient) GetFibonacciSlice(ctx context.Context, in *BorderValues, opts ...grpc.CallOption) (*FibonacciSlice, error) {
	out := new(FibonacciSlice)
	err := c.cc.Invoke(ctx, "/Fibonacci/GetFibonacciSlice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	GetFibonacciSlice(context.Context, *BorderValues) (*FibonacciSlice, error)
...
func (UnimplementedFibonacciServer) GetFibonacciSlice(context.Context, *BorderValues) (*FibonacciSlice, error) {
...
func _Fibonacci_GetFibonacciSlice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BorderValues)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServer).GetFibonacciSlice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Fibonacci/GetFibonacciSlice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).GetFibonacciSlice(ctx, req.(*BorderValues))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Fibonacci_GetFibonacciSlice_Handler,
		},
	},
